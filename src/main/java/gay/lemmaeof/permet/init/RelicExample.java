...
public class RelicExample {
    ...
    public static Item[] test(BiFunction<String, Relic, Item> regFunc) {
        ...
        */
        ...
        Supplier<EffectForge> burnGuysEffect = () -> new EffectForge(FlameEffect::new, new FlameEffect.Core());
        ...
        Function<EffectForge, EffectForge> enhanceEffect = e -> e
            .aspect(EffectRelicCore.DURATION, 10)
            .aspect(EffectRelicCore.INTENSITY, 5f);
        ...
        var t3Upgrade = t2Upgrade.andThen(
            r -> r.aspect(ToolRelicCore.MATERIAL, ToolMaterials.NETHERITE)
        );
        ...
        Supplier<RelicForge> base = () -> new RelicForge(MiningToolRelic::new, axeAttributes.get());
    ...
    public static Item makeBigKnife(BiFunction<String, Relic, Item> regFunc) {
        ...
        EffectForge carvingModifier = new EffectForge(CarvingEffect::new, new CarvingEffect.Core())
        ...
        var bigKnife = RelicForge.sword().core(bigKnifeCore.get())
